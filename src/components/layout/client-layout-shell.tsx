...
export function ClientLayoutShell({ children, user }: ClientLayoutShellProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      ...
      <div className="h-[calc(100vh-104px)] overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row gap-5">
              ...
              <div className="flex-1 min-w-0">
                {shouldBlockWorkspace ? (
                  <div className="mx-auto flex min-h-[calc(100vh-16rem)] max-w-2xl items-center justify-center">
                    <Card className="w-full border-none shadow-sm ring-1 ring-slate-200">
